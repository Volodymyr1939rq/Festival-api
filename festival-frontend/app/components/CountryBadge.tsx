...
export function CountryBadge({country}:CountryBadgeProps){
    ...
    return (
        <div 
          ...
          className="relative flex items-center group cursor-default z-10 drop-shadow-[0_4px_12px_rgba(0,0,0,0.25)] ml-4 shrink-0 max-w-27.5 sm:max-w-32.5"
          title={countryName} 
        >
        
          
            <div className="bg-white text-[#0a113e] pl-8 pr-3 h-7 flex items-center justify-center rounded-r-full font-extrabold text-[12px] tracking-wide w-full min-w-0">
            ...
            <div className="absolute -left-6 top-1/2 -translate-y-1/2 z-20 group-hover:scale-105 transition-transform duration-300 w-12 h-12 shrink-0">
